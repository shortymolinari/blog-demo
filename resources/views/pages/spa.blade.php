...
<head>
    ...
    <title>@yield('meta-title', config('app.description') . '| Blog')</title>
    <meta name="description" content="@yield('meta-description' ,'Este es el blog de sendero (150-160carateres el otro 60)')" />
    ...
    <div id="app">
        ...
        <div class="page-wrapper">
            <transition name="slide-fade" mode="out-in">
                {{-- aqui es donde aparece cada vista de VueJS (Router View) --}}
